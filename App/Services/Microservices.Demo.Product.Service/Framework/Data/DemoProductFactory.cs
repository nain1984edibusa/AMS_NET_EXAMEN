...
namespace Microservices.Demo.Products.Service.Framework.Data
{
    ...
    {
        internal static Entities.Product Travel()
        {
            var p = Entities.Product.CreateDraft(
                "TRI",
                "Safe Traveller",
                "/static/travel.jpg",
                "Travel insurance",
        ...
        internal static Entities.Product House()
        {
            var p = Entities.Product.CreateDraft(
                "HSI",
                "Happy House",
        ...
        internal static Entities.Product Farm()
        {
            var p = Entities.Product.CreateDraft(
                "FAI",
                "Happy farm",
        ...
        internal static Entities.Product Car()
        {
            var p = Entities.Product.CreateDraft(
                "CAR",
                "Happy Driver",
