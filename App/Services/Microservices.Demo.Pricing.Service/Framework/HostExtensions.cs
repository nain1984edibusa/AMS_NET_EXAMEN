using Microservices.Demo.Pricing.Service.Framework.Data;
using Microservices.Demo.Pricing.Service.Framework.DI;
using Microservices.Demo.Pricing.Service.Framework.Web;
using Microservices.Infrastructure.Trace;
using Scalar.AspNetCore;
using Steeltoe.Discovery.Client;

namespace Microservices.Demo.Pricing.Service.Framework
{
